...
urlpatterns = [
    ...
    path('a', views.love, name='love_url'),
    ...
    path('question/<int:pk>/answer/', views.AnswerCreateView.as_view(), name='answer_create'),
    path('answer/<int:answer_id>/like/', views.LikeView.as_view(), name='answer_like'),
